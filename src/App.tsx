...
function Quiz({arc,state,onUpdate,onClose}){
  ...
  return(
    <div style={{position:"fixed",inset:0,zIndex:300,background:"rgba(5,10,20,0.98)",display:"flex",flexDirection:"column",padding:"20px",fontFamily:"Nunito,sans-serif",animation:"fadeIn 0.4s ease"}}>
